              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Text(
                        '${cuerpoCeleste.descripcion}, este objeto celeste : " ${cuerpoCeleste.tipo} " pertenece al Sistema con el ID: ${cuerpoCeleste.sistemaId.toString()} '),
                  ),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: <Widget>[
                    Icon(
                      Icons.star,
                      color: Color.fromARGB(255, 227, 69, 103),
                    ),
                    Icon(
